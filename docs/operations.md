...
| Certificate error       | Internal CA mounted and `NODE_EXTRA_CA_CERTS` set, without disabling TLS ([Internal certificate authority](deployment.md#internal-certificate-authority)) |
