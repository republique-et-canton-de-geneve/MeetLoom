...
4. A group is a frame around ordinary blocks: blocks inside it look and behave like any other block. Add activities with **Add an activity to the group**, and drag blocks into a group or a parallel room, or out of it; a green line shows where the block will land. Durations are computed automatically.
